...
//   if (liveDemoLink === 'Private') {
//     Swal.fire({
//       icon: 'info',
//       title: 'Live Demo Not Available',
//       text: 'Sorry, the live demo for this project is not available at the moment.',
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                {/* <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-blue-500/20 rounded-xl hover:bg-blue-500/30 transition-colors border border-blue-500/30 hover:border-blue-500/50 text-blue-400 hover:text-blue-300"
                >
